...
// let yGrid = 10;
// function drawGrid() {
//   while (xGrid < c.height) {
//     ctx.moveTo(0, xGrid);
//     ctx.lineTo(c.width, xGrid);
//     xGrid += 10;
//     // ctx.stroke();
//   }
//   while (yGrid < c.width) {
//     ctx.moveTo(yGrid, 0);
//     ctx.lineTo(yGrid, c.height);
//     yGrid += 10;
//     // ctx.stroke();
//   }
// }
// drawGrid();
// let cellSize = 10;
// var d = new Date(2017, 11, 31);
// var dateDiff;
//   return 50 - (spd * 0.5);
// function yBlock(spd) {
// }
// for (const key in data18) {
//   if (Object.hasOwnProperty.call(data18, key)) {
//     var element = data18[key];
//     let date2 = new Date(key);
//     let diffTime = Math.abs(date2 - d);
//     dateDiff = Math.ceil(diffTime / (1000 * 60 * 60 * 24));
//     let xCord = dateDiff;
//     let yCord = yBlock(element);
//     (function (){
//         console.log("x :" + xCord + " and y :" + yCord);
//         var tempX = 5;
//         var tempY = 54;
//         ctx.beginPath();
//         ctx.moveTo(blocks(tempX),blocks(tempY));
//         ctx.lineTo(23,27);
//         ctx.stroke();
//     })();
